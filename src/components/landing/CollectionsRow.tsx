        ...
        <div className="flex gap-2 pb-2">
          {collections.map((collection) => (
            <button
              ...
              className={cn(
                "flex-shrink-0 w-[80px] md:w-[90px] rounded-lg overflow-hidden transition-all duration-200",
            ...
            >
              ...
              <div className="relative h-12 md:h-14">
                ...
                <span className="absolute bottom-0.5 left-1/2 -translate-x-1/2 text-lg">
                  {collection.emoji}
                </span>
              </div>
              ...
              <div className="bg-card px-1.5 py-1 text-center">
                <span className="text-[10px] md:text-xs font-medium text-foreground line-clamp-1">
